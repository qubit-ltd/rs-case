...
fn test_to_converts_lower_hyphen_to_all_styles() {
    ...
    assert_eq!(LOWER_HYPHEN.to(LOWER_UNDERSCORE, source), "hello_world_everybody");
    ...
    assert_eq!(LOWER_HYPHEN.to(UPPER_UNDERSCORE, source), "HELLO_WORLD_EVERYBODY");
}
...
fn test_to_converts_lower_underscore_to_all_styles() {
    ...
    assert_eq!(LOWER_UNDERSCORE.to(LOWER_HYPHEN, source), "hello-world-everybody");
    assert_eq!(LOWER_UNDERSCORE.to(LOWER_UNDERSCORE, source), source);
    assert_eq!(LOWER_UNDERSCORE.to(LOWER_CAMEL, source), "helloWorldEverybody");
    assert_eq!(LOWER_UNDERSCORE.to(UPPER_CAMEL, source), "HelloWorldEverybody");
    assert_eq!(LOWER_UNDERSCORE.to(UPPER_UNDERSCORE, source), "HELLO_WORLD_EVERYBODY");
}
...
fn test_to_converts_upper_underscore_to_all_styles() {
    ...
    assert_eq!(UPPER_UNDERSCORE.to(LOWER_HYPHEN, source), "hello-world-everybody");
    assert_eq!(UPPER_UNDERSCORE.to(LOWER_UNDERSCORE, source), "hello_world_everybody");
    assert_eq!(UPPER_UNDERSCORE.to(LOWER_CAMEL, source), "helloWorldEverybody");
    assert_eq!(UPPER_UNDERSCORE.to(UPPER_CAMEL, source), "HelloWorldEverybody");
